 ...
 * @author nicho
 */
public class Adminapp extends javax.swing.JFrame implements Runnable{
    ...
    public void bookcheck(){
        try{
            ...
            rs = st.executeQuery("SELECT `Quantity` FROM `bookstock` WHERE `Quantity`<5");
            if(rs.next()){
                ResultSet rs1 = st.executeQuery("SELECT `BookId`, `BookName`, `Quantity` FROM `bookstock` WHERE `Quantity`<5");
                jLabel2.setVisible(true);
                jScrollPane1.setVisible(true);
                bookchecktable.setModel(DbUtils.resultSetToTableModel(rs1));
                getToolkit().beep();
                ImageIcon icon = new ImageIcon(getClass().getResource("/User/icon/loss_50px.png"));
                JOptionPane.showMessageDialog(null,"Stock Runing Low.","Warning",JOptionPane.WARNING_MESSAGE, icon);
                }
    ...
    public Adminapp() {
        //bookchecktable.setVisible(false);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/User/icon/icons8_user_shield_75px.png"))); // NOI18N
        jLabel3.setText("Administator");
        ...
        jPanel4Layout.setVerticalGroup(
            jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 63, Short.MAX_VALUE)
        );
        ...
        jLabel20.setIcon(new javax.swing.ImageIcon("C:\\Users\\nicho\\OneDrive\\Pictures\\Webp.net-resizeimage (2).png")); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/User/icon/icons8_combo_chart_25px.png"))); // NOI18N
        jLabel8.setText("Report/s");
        ...
        jPanel7.setBackground(new java.awt.Color(168, 194, 251));
        ...
        jLabel10.setBounds(50, 10, 96, 25);
        ...
        jLabel11.setBounds(170, 10, 114, 25);
        ...
        jLabel12.setBounds(300, 10, 77, 25);
        ...
        jLabel13.setBounds(390, 10, 93, 25);
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/User/icon/low-stock-300x300.png"))); // NOI18N
        jLabel2.setLabelFor(bookchecktable);
        ...
        bookchecktable.setBackground(new java.awt.Color(71, 120, 197));
        bookchecktable.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        bookchecktable.setForeground(new java.awt.Color(255, 255, 255));
        bookchecktable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "BookId", "BooKName", "QuantityLeft"
            }
        ));
        jScrollPane1.setViewportView(bookchecktable);

        jPanel5.add(jScrollPane1);
        jScrollPane1.setBounds(280, 190, 260, 90);
